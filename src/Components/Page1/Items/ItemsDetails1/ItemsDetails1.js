          ...
          <div className='col-md-5'>
            <div className='itemsDetails-container'>
              <div className='itemsDetails-img'>
                ...
                <p><FontAwesomeIcon className='heartIcon' icon={faHeart} /> 34</p>
                </div>
                <img src={pxart2} alt=''/>
              </div>
          ...
          <div className='col-md-7'>
            <div className='itemsDetails-contents d-flex'>
              <div className='itemsDetails-text'>
                ...
                <small>Owned by <span>WFSHJR</span></small> <span><FontAwesomeIcon className='heartIcon' icon={faHeart} /> 34 favorites</span>
